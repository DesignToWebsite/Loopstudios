...
function diplayMenuItems(creationItem) {
  let displayMenu = creationItem.map(function (item) {
    return `<div class="col-lg-3 col-md-4 col-sm-4 col-6">
      <div class="catalogue" style = "background:linear-gradient(to bottom,rgba(0, 0, 0,0.5),rgba(0, 0, 0,0.7)), url(${item.img}) no-repeat center center / cover; height: 400px; margin-top:10px;margin-bottom : 10px;">  
        <div class="span">
